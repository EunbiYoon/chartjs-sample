...
labels=list(range(1,len(result.index)+1))

values2M=result['Sales_'+date2M_name].fillna(0).to_list()
values1M=result['Sales_'+date1M_name].fillna(0).to_list()
values0M=result['Sales_'+date0M_name].fillna(0).to_list()
